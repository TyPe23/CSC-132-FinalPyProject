...
class Player(pygame.sprite.Sprite):
    ...
    def shoot(self):
        if (self.rect.bottom <= HEIGHT - 30):
            bullet1 = Bullet(self.rect.centerx + 12, self.rect.top, 12, 14, 1, -11)
            bullet2 = Bullet(self.rect.centerx - 22, self.rect.top, 12, 14, -1, -11)
...
player = Player(charLeft, WIDTH / 2, HEIGHT + 100, 84, 48)
...
#enemies.add(EvadingEnemy(enemySprites[3], 10, 4.5, 4.5, player))
