...
class Player(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        if (self.rect.bottom <= HEIGHT - 30) and (Player.straightShot == True):
            bullet1 = Bullet(self.rect.centerx + 15, self.rect.top, 12, 14, 0, -11)
            bullet2 = Bullet(self.rect.centerx - 22, self.rect.top, 12, 14, 0, -11)
            bullets.add(bullet1, bullet2)
        
        elif (self.rect.bottom <= HEIGHT - 30) and (Player.vShot == True):
            bullet1 = Bullet(self.rect.centerx + 15, self.rect.top, 12, 14, 3, -11)
            bullet2 = Bullet(self.rect.centerx - 22, self.rect.top, 12, 14, -3, -11)
            bullets.add(bullet1, bullet2)
...
class Boss(pygame.sprite.Sprite):
    ...
    def update(self, screen):
        ...
        if self.rect.top <= 0:
            ...
            if self.untouchableCannonDelay % 50 == 0:
    ...
    def rotatingAttack(self, screen):
        ...
        if self.rotatingDelay % 40 == 0:
            enemyBullet1 = EnemyRotatingBullet(bulletImg, 10, 20, leftPos, direction.normalize(), 20)
            enemyBullet2 = EnemyRotatingBullet(bulletImg, 10, 20, rightPos, direction.normalize(), 20) 
            enemyBullets.add(enemyBullet1, enemyBullet2)
...
toggleStraight = [pygame.image.load('sprites/Toggle/Toggle.png'), pygame.image.load('sprites/Toggle/Toggle2.png')]
toggleWide = [pygame.image.load('sprites/Toggle/Toggle3.png'), pygame.image.load('sprites/Toggle/Toggle4.png')]
...
player = Player(char, WIDTH / 2 - 42, HEIGHT + 100, 84, 48)
